...
sensobol::load_packages(c("data.table", "tidyverse", "openxlsx", "tm", "stringr", 
                          ...
                          "LSAfun", "ggrepel", "tidyquant", "parallel", "benchmarkme"))
...
```{r merge_plots_descriptive, dependson="plots_descriptive", fig.width=5.5, warning=FALSE}
...
```{r plot_merged_token, dependson=c("token_analysis", "merge_plots_descriptive"), fig.height=8, warning=FALSE, fig.width=6}
